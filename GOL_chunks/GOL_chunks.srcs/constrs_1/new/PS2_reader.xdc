...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { i_sys_rst }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { i_ready }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { o_data_valid }]; #IO_L10P_T1_D14_14 Sch=led16_g
...
##USB HID (PS/2)
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { i_ps2_clk }]; #IO_L13P_T2_MRCC_35 Sch=ps2_clk
create_clock -add -name ps2_clk -period 50000.00 [get_ports {i_ps2_clk}];
set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33 } [get_ports { i_ps2_dat }]; #IO_L10N_T1_AD15N_35 Sch=ps2_data

set_clock_groups -asynchronous -group [get_clocks ps2_clk]

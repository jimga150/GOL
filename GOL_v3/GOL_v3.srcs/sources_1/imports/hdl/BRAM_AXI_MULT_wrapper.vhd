...
entity BRAM_AXI_MULT_wrapper is
  port (
    ...
    --S_AXI_0 runs on 50 MHz clock for SD card
    S_AXI_0_araddr : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_0_arprot : in STD_LOGIC_VECTOR ( 2 downto 0 ) := (others => '0');
    S_AXI_0_arready : out STD_LOGIC;
    S_AXI_0_arvalid : in STD_LOGIC := '0';
    
    S_AXI_0_awaddr : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_0_awprot : in STD_LOGIC_VECTOR ( 2 downto 0 ) := (others => '0');
    S_AXI_0_awready : out STD_LOGIC;
    S_AXI_0_awvalid : in STD_LOGIC := '0';
    
    S_AXI_0_bready : in STD_LOGIC := '0';
    S_AXI_0_bresp : out STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_0_bvalid : out STD_LOGIC;
    
    S_AXI_0_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    S_AXI_0_rready : in STD_LOGIC := '0';
    S_AXI_0_rresp : out STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_0_rvalid : out STD_LOGIC;
    
    S_AXI_0_wdata : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_0_wready : out STD_LOGIC;
    S_AXI_0_wstrb : in STD_LOGIC_VECTOR ( 3 downto 0 ) := (others => '1');
    S_AXI_0_wvalid : in STD_LOGIC := '0';
    
    
    
    S_AXI_1_araddr : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_1_arprot : in STD_LOGIC_VECTOR ( 2 downto 0 ) := (others => '0');
    S_AXI_1_arready : out STD_LOGIC;
    S_AXI_1_arvalid : in STD_LOGIC := '0';
    
    S_AXI_1_awaddr : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_1_awprot : in STD_LOGIC_VECTOR ( 2 downto 0 ) := (others => '0');
    S_AXI_1_awready : out STD_LOGIC;
    S_AXI_1_awvalid : in STD_LOGIC := '0';
    
    S_AXI_1_bready : in STD_LOGIC := '0';
    S_AXI_1_bresp : out STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_1_bvalid : out STD_LOGIC;
    
    S_AXI_1_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    S_AXI_1_rready : in STD_LOGIC := '0';
    S_AXI_1_rresp : out STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_1_rvalid : out STD_LOGIC;
    
    S_AXI_1_wdata : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_1_wready : out STD_LOGIC;
    S_AXI_1_wstrb : in STD_LOGIC_VECTOR ( 3 downto 0 ) := (others => '1');
    S_AXI_1_wvalid : in STD_LOGIC := '0';
    
    
    
    S_AXI_2_araddr : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_2_arprot : in STD_LOGIC_VECTOR ( 2 downto 0 ) := (others => '0');
    S_AXI_2_arready : out STD_LOGIC;
    S_AXI_2_arvalid : in STD_LOGIC := '0';
    
    S_AXI_2_awaddr : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_2_awprot : in STD_LOGIC_VECTOR ( 2 downto 0 ) := (others => '0');
    S_AXI_2_awready : out STD_LOGIC;
    S_AXI_2_awvalid : in STD_LOGIC := '0';
    
    S_AXI_2_bready : in STD_LOGIC := '0';
    S_AXI_2_bresp : out STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_2_bvalid : out STD_LOGIC;
    
    S_AXI_2_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    S_AXI_2_rready : in STD_LOGIC := '0';
    S_AXI_2_rresp : out STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_2_rvalid : out STD_LOGIC;
    
    S_AXI_2_wdata : in STD_LOGIC_VECTOR ( 31 downto 0 ) := (others => '0');
    S_AXI_2_wready : out STD_LOGIC;
    S_AXI_2_wstrb : in STD_LOGIC_VECTOR ( 3 downto 0 ) := (others => '1');
    S_AXI_2_wvalid : in STD_LOGIC := '0';
